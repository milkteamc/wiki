...
10. 非經服主、主要管理許可，禁止使用創造、飛行、小木斧、`/fill`、`/god` 等功能。
11. 伺服器所有規則，服主、主要管理有最終決定權。

## 遊戲內細則
1. 10人以上禁止冰船、飛行、RTP及鞘翅跑圖、造成生物堆積以及大量掉落物的機器，若違反者警告2次無果封禁該玩家(不封鎖IP)。午夜00:00-早上8:00(UTC+8)不限制上述之規則。
2. 玩家村民交易所，切勿囤積以及大量繁殖但閒置不用。
3. 地獄上方基岩層嚴禁掛機跑圖。
